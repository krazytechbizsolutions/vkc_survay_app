11-02-2021,
	...
	1. Logout icon on top right side. On click show confirmation.
	...
	8. [JOE] Survey should be displayed in the app based on the User and as per his dayplan, currently not getting filtered as per the User & Dayplan.
	9. [JOE] "Feedback" - Feedback Question- Only two lines are available for text input, below lines are hidden/not able to type more than 2lines
	10. Provide the individual survey link for starting the survey directly.
	11. Direct survey start implementation on the app.
	12. [JOE] Enable the rating label to show above the stars.
	13. Multiple image issue still persists.
	14. Multiple image capture is allowed till 10.
